import img from '../../assets/icons/ppp.png';
export const MenuDish = ({data}) => {
  return (
    <div className='flex md:items-center md:flex-row w-full flex-col gap-4 '>
        ...
        <div className='w-full flex  xl:items-end  flex-col md:flex-row justify-between gap-[10px] '>
            ...
            <hr className='border-none bg-[#AAAAAA]  mb-2 md:block h-[4px] w-full hidden ' />
            <div>
